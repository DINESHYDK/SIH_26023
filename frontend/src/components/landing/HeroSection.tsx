    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-space-xl py-space-3xl">
        <div className="max-w-4xl flex flex-col gap-space-lg">
          <span className="font-mono-label text-[14px] leading-5 text-mining-gold-bright uppercase tracking-widest">
            Problem Statement ID: #26023
          </span>
          {/* Hero-scale headline: the design system's largest token (headline-xl,
              36px) is meant for card/section titles, not a full-viewport hero, so
              this is sized directly here rather than bumping that shared token
              (which is also used by DemoVideo/MLPipeline/try-out). */}
          <h1 className="font-headline-xl text-[40px] sm:text-[56px] lg:text-[72px] leading-[1.05] text-text-primary tracking-tight font-bold">
          ...
          <div className="pt-space-xs">
            <Link
              className="inline-flex items-center gap-space-sm px-space-xl py-space-base rounded-lg bg-primary-container text-surface-base font-bold shadow-xl shadow-primary-container/20 hover:bg-mining-gold-deep transition-all transform hover:-translate-y-0.5"
              href={ctaHref}
            >
